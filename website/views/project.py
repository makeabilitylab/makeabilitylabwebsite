...
def project(request, project_name):
    ...
    context = {'banners': displayed_banners,
               ...
               'inactive_PIs': project_leadership['inactive_PIs'],
               'active_CoPIs': project_leadership['active_CoPIs'],
               'inactive_CoPIs': project_leadership['inactive_CoPIs'],
               'inactive_PIsAndCoPIs': project_leadership['inactive_PIsAndCoPIs'],
