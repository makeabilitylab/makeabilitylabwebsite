"""
Tests for website.utils.bio_utils.auto_generate_bio and its helpers.

Tests use mocks rather than real Person/Position records so they don't have to
navigate Person.save() side-effects (random image assignment, file I/O); the
unit under test is pure presentation logic.
"""
