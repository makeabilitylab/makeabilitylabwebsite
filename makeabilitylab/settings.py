...
ML_WEBSITE_VERSION = "2.2.7" # Keep this updated with each release and also change the short description below
ML_WEBSITE_VERSION_DESCRIPTION = "Added triangle art holiday easter egg to homepage"
