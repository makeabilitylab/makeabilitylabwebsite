...
ML_WEBSITE_VERSION = "2.3.2" # Keep this updated with each release and also change the short description below
ML_WEBSITE_VERSION_DESCRIPTION = "Added some Claude bug fixes"
