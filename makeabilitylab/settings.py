...
ML_WEBSITE_VERSION = "1.9.9.8" # Keep this updated with each release and also change the short description below
ML_WEBSITE_VERSION_DESCRIPTION = "Updated admin UI landing page"
