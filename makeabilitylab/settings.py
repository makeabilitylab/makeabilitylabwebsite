...
ML_WEBSITE_VERSION = "2.2.4" # Keep this updated with each release and also change the short description below
ML_WEBSITE_VERSION_DESCRIPTION = "Fixes talk cards on mobile"
