...
ML_WEBSITE_VERSION = "2.2.1" # Keep this updated with each release and also change the short description below
ML_WEBSITE_VERSION_DESCRIPTION = "Fixed footer responsiveness"
